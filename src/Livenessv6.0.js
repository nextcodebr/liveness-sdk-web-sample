...
class Liveness {
  ...
  constructor (videoWrapper, config) {
    ...
    this.handleBeforeSubmitFunction = config.handleBeforeSubmitFunction
  }
  ...
  takePicture () {
    ...
    setTimeout(() => {
      ...
      if (!!this.handleBeforeSubmitFunction) {
        this.handleBeforeSubmitFunction()
        return
      }
  ...
  removeMessageBox () {
    const boxMessage = document.getElementById('liveness-box-message')
    if (boxMessage) boxMessage.remove()
  }
  createMessageBox () {
