...
class Liveness {
  ...
  constructor (videoWrapper, config) {
    ...
    if (config.dimensions) {
      ...
      this.config.width = config.dimensions.width
      this.config.height = config.dimensions.height
    }
    ...
    this.checkNeutralFace = config.checkNeutralFace || false
  ...
  loop () {
    ...
    this.timer = setInterval(async () => {
      ...
      if (resizedDetections && resizedDetections.expressions && this.checkNeutralFace) {  
